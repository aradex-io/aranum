# `standalones/ot/` — OT / ICS read-side identification
...
**Scope anchor:** [`aranumtoolkit/docs/ADR-005-22MAY2026-ot-ics-safety-scope.md`](../../aranumtoolkit/docs/ADR-005-22MAY2026-ot-ics-safety-scope.md)
**Roadmap:** [`aranumtoolkit/docs/ROADMAP-003-22MAY2026-tier4-ics-enumeration.md`](../../aranumtoolkit/docs/ROADMAP-003-22MAY2026-tier4-ics-enumeration.md)
...
bash standalones/ot/ot-enum.sh --ics-confirm --targets targets.txt --output ./ot-out
```
...
a one-line `OT-ID <proto> <ip>:<port> — <fields>` hit. `aranumtoolkit/network/report.py`
