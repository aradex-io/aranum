#!/usr/bin/env bash
# standalones/ot/enum-modbus.sh — Modbus TCP 502 read-side identification.
#
...
#
# Anchor: aranumtoolkit/docs/ADR-005-22MAY2026-ot-ics-safety-scope.md §D2 §D5
# Plan:   aranumtoolkit/docs/ROADMAP-003 §T4.1
