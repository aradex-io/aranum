#!/usr/bin/env python3
"""test_gql_internals.py — G.3 unit tests for graphql/gql.py.
...
or:       python3 tests/test_gql_internals.py
"""
...
GQL_PATH = REPO / "graphql" / "gql.py"


def _load_module():
    # Redirect the cache dir to a tmp so test runs don't pollute graphql/.cache
