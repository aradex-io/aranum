    ...
    case "$port" in
        ...
        61616)
            ...
            if grep -qi 'ActiveMQ' "$d/openwire.txt" 2>/dev/null; then
                hit "$ip:$port  OpenWire confirmed — CVE-2023-46604 candidate -> standalones/activemq/activemq-cve-2023-46604.py"
...
log "activemq dispatcher done. Deep exploitation: standalones/activemq/ toolkit"
