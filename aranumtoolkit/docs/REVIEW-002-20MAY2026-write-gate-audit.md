...
This document audits every helper in `standalones/activemq/`, `standalones/redis/`, `standalones/smtp/`, `standalones/jabber/`,
and `standalones/creds/` to verify the invariant. Where the audit found a violation, the
...
Any new helper added to `standalones/activemq/`, `standalones/redis/`, `standalones/smtp/`, `standalones/jabber/`, `standalones/creds/`, or
...
The smoke test in `aranumtoolkit/tests/smoke.sh` will be extended in G.7-followup to assert
